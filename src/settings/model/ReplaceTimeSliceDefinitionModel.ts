...
export interface ReplaceTimeSliceDefinitionModel {
    name?: string;

    template: ReplaceTimeSliceDefinitionModel.TemplateEnum;
...
export namespace ReplaceTimeSliceDefinitionModel {
...
export type ReplaceTimeSliceDefinitionModelWithRawHttp = ReplaceTimeSliceDefinitionModel & ResponseModel<ReplaceTimeSliceDefinitionModel>;
...
export namespace ReplaceTimeSliceDefinitionModel {
    ...
    export function $buildForm(fb: FormBuilder, options?: BuildFormOptions<ReplaceTimeSliceDefinitionModel>): FormGroup {
